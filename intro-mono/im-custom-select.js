...
bodySections.forEach(section=>{
  ...
  allSelects.forEach(select=>{
    ...
    select.addEventListener('click', ()=>{
      ...
      if(style == "Extra Light"){
        text.style['font-variation-settings'] = `"wght" 45, "slnt" 0`
      } else if(style == "Light"){
        text.style['font-variation-settings'] = `"wght" 60, "slnt" 0`
      } else if(style == "Regular"){
        text.style['font-variation-settings'] = `"wght" 80, "slnt" 0`
      } else if(style == "Medium"){
        text.style['font-variation-settings'] = `"wght" 95, "slnt" 0`
      } else if(style == "SemiBold"){
        text.style['font-variation-settings'] = `"wght" 110, "slnt" 0`
      } else if(style == "Bold"){
        text.style['font-variation-settings'] = `"wght" 150, "slnt" 0`
      } 
    })
  })
})
